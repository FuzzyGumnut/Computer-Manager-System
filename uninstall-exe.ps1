# Computer Manager Client EXE Uninstaller for Windows
# Run this script to remove the Computer Manager client

Write-Host "Computer Manager Client EXE Uninstaller" -ForegroundColor Cyan
...
try {
    Get-Process -Name client -ErrorAction SilentlyContinue | Stop-Process -Force
